...
FCOL <- foreach(l = 1:nsim,
                ...
                .options.snow = opts
                ) %dopar% splvm.simfit(l,a)

stopCluster(cl)
# if(cleanRes) FCOL <- FCOL[FCOL[,ncol(FCOL)] %!in% c(1000,-999),-ncol(FCOL)]
if(saveRes) save(FCOL, file = paste0("Ex2_","nsim",nsim,"_n",n, "_p", p,"_a",a,".RData"))
